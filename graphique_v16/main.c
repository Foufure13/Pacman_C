...
int main(int argc, char** argv)
{
  ...
  Ghost fantomRed = {
    ...
    { map.x/2, map.y/2, 15, 15 },  // initialisation de fantom_dstrect   
    0.0, 0.0, //vitesse
    0, 0,     //direction
    0, 0, 0, 0, //vision
    1}; //Gtype
    ...
    debut = clock();  // enregistrer l'heure de début
...
initialisation_fenetre();
    ...
    while (programme && rect_image.vie > 0)
    {
        ...
        collision_fantom_pacman(&map, &pacman_dstrect,  &rect_image,   fantomRed );
        ...
        Affichage_fantom (&map,rendu,  &fantomRed);
