...
void clear_menu(TTF_Font* font, SDL_Surface* surface_pacman, SDL_Surface* surface_space, SDL_Texture *texture_pacman_image, SDL_Texture *texture_pacman, SDL_Texture *texture_space, SDL_Renderer *renderer, SDL_Window *fenetre) {
    TTF_CloseFont(font);
        ...
        while (SDL_PollEvent(&event))
            {
                switch(event.type)
                {
                    ...
                    case SDLK_SPACE:
                        programme=SDL_FALSE;
                        choice=SDL_TRUE;
                        clear_menu(font, surface_pacman, surface_space, texture_pacman_image, texture_pacman, texture_space, renderer, fenetre);
                        return choice;
                    break;
                    default:                
                        continue;
