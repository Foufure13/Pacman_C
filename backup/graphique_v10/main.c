...
#define windows_settings_width 2
#define windows_settings_height 1
...
int main(int argc, char** argv)
{
    ...
    int windowLargeur = map.x = 32 + (windows_settings_width * 16 *4);
    int windowHauteur = map.y = 32 + (windows_settings_height * 16 * 10 );
...
initialisation_fenetre();
    ...
    while (programme)
    {
        ...
        structur_map(&map, fenetre,rendu);
